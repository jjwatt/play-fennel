...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _701_()
      local _700_0 = errtype
      if (_700_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _710_()
      local _708_0, _709_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _708_0) and (nil ~= _709_0)) then
        local body = _708_0
        local _return = _709_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_712_()) do
    ...
    do
      local _721_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _721_0) then
        local cmd_fragment = _721_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _725_0, _726_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_725_0 == true) and (nil ~= _726_0)) then
      local old = _726_0
      local _ = nil
      ...
      local new = nil
      do
        local _727_0, _728_0 = pcall(require, module_name)
        if ((_727_0 == true) and (nil ~= _728_0)) then
          local new0 = _728_0
          new = new0
        elseif (true and (nil ~= _728_0)) then
          local _0 = _727_0
          local msg = _728_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_725_0 == false) and (nil ~= _726_0)) then
      local msg = _726_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _733_()
          local _732_0 = msg:gsub("\n.*", "")
          return _732_0
        end
        return on_error("Runtime", _733_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _736_0, _737_0, _738_0 = pcall(read)
    if ((_736_0 == true) and (_737_0 == true) and (nil ~= _738_0)) then
      local val = _738_0
      local _739_0, _740_0 = pcall(f, val)
      if ((_739_0 == false) and (nil ~= _740_0)) then
        local msg = _740_0
        return on_error("Runtime", msg)
      end
    elseif (_736_0 == false) then
  ...
  commands.reload = function(env, read, on_values, on_error)
    ...
    return run_command(read, on_error, _743_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _745_0 = type(subtbl)
        if (_745_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_745_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _747_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _751_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _755_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _755_0) then
            local docstr = _755_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    local function _759_(_241)
      return on_values(apropos_doc(tostring(_241)))
    end
    return run_command(read, on_error, _759_)
  end
  ...
  local function resolve(identifier, _762_0, scope)
    local _763_ = _762_0
    local env = _763_
    local ___replLocals___ = _763_["___replLocals___"]
    local e = nil
    local function _764_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _764_})
    local function _765_(...)
      local _766_0, _767_0 = ...
      if ((_766_0 == true) and (nil ~= _767_0)) then
        local code = _767_0
        local function _768_(...)
          local _769_0, _770_0 = ...
          if ((_769_0 == true) and (nil ~= _770_0)) then
            local val = _770_0
            return val
          else
            local _ = _769_0
        ...
        return _768_(pcall(specials["load-code"](code, e)))
      else
        local _ = _766_0
        return nil
      end
    end
    return _765_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _773_(_241)
      local _774_0 = nil
      do
        local _775_0 = utils["sym?"](_241)
        if (nil ~= _775_0) then
          local _776_0 = resolve(_775_0, env, scope)
          if (nil ~= _776_0) then
            _774_0 = debug.getinfo(_776_0)
          else
            _774_0 = _776_0
          end
        else
      ...
      if ((_G.type(_774_0) == "table") and (nil ~= _774_0.linedefined) and (nil ~= _774_0.short_src) and (nil ~= _774_0.source) and (_774_0.what == "Lua")) then
        local line = _774_0.linedefined
        local src = _774_0.short_src
        local source = _774_0.source
        local fnlsrc = nil
        do
          local _779_0 = compiler.sourcemap
          if (nil ~= _779_0) then
            _779_0 = _779_0[source]
          end
          if (nil ~= _779_0) then
            _779_0 = _779_0[line]
          end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _784_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _787_(_241)
      local _788_0, _789_0 = pcall(compiler.compile, _241, opts)
      if ((_788_0 == true) and (nil ~= _789_0)) then
        local result = _789_0
        return on_values({result})
      elseif (true and (nil ~= _789_0)) then
        local _2 = _788_0
        local msg = _789_0
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _791_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _791_0) then
          local cmd_name = _791_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _793_0 = commands[command_name]
      if (nil ~= _793_0) then
        local command = _793_0
  ...
  local function repl(_3foptions)
    ...
    local _802_ = utils.copy(_3foptions)
    local opts = _802_
    local _3ffennelrc = _802_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    byte_stream, clear_stream = parser.granulate(_804_)
    local chars = {}
    local read, reset = nil, nil
    local function _805_(parser_state)
    ...
    read, reset = parser.parser(_805_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _811_()
        local _810_0 = opts.scope
        local function _812_(...)
          return completer(env, _810_0, ...)
        end
        return _812_
      end
      opts.registerCompleter(_811_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _816_(...)
            local _817_0, _818_0 = ...
            if ((_817_0 == true) and (nil ~= _818_0)) then
              local src = _818_0
              local function _819_(...)
                local _820_0, _821_0 = ...
                if ((_820_0 == true) and (nil ~= _821_0)) then
                  local chunk = _821_0
                  ...
                  return xpcall(_822_, _823_)
                elseif ((_820_0 == false) and (nil ~= _821_0)) then
                  local msg = _821_0
                  clear_stream()
              ...
              return _819_(_826_(...))
            elseif ((_817_0 == false) and (nil ~= _818_0)) then
              local msg = _818_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _816_(pcall(compiler.compile, form, _828_()))
  ...
  local function _834_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _834_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _631_0 = (_3fopts or utils.root.options)
      if ((_G.type(_631_0) == "table") and (_631_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_631_0) == "table") and (nil ~= _631_0.compilerEnv)) then
        local compilerEnv = _631_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_631_0) == "table") and (nil ~= _631_0["compiler-env"])) then
        local compiler_env = _631_0["compiler-env"]
    ...
    local function _634_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _635_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _636_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _633_, ["in-scope?"] = _634_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _635_, list = utils.list, macroexpand = _636_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _639_ = _637_(...)
  local dirsep = _639_[1]
  local pathsep = _639_[2]
  local pathmark = _639_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _640_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _640_0) then
        local file = _640_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _642_0 = fullpath:match(pattern, start)
      if (nil ~= _642_0) then
        local path = _642_0
        local _643_0, _644_0 = try_path(path)
        if (nil ~= _643_0) then
          local filename = _643_0
          return filename
        elseif ((_643_0 == nil) and (nil ~= _644_0)) then
          local error = _644_0
          local function _646_()
            local _645_0 = (_3ftried_paths or {})
            table.insert(_645_0, error)
            return _645_0
          end
          return find_in_path((start + #path + 1), _646_())
        end
      else
        local _ = _642_0
  ...
  local function make_searcher(_3foptions)
    local function _651_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _652_0, _653_0 = search_module(module_name)
      if (nil ~= _652_0) then
        local filename = _652_0
        local function _654_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _654_, filename
      elseif ((_652_0 == nil) and (nil ~= _653_0)) then
        local error = _653_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _656_0 = utils.copy(utils.root.options)
      _656_0["module-name"] = module_name
      _656_0["env"] = "_COMPILER"
      _656_0["requireAsInclude"] = false
      _656_0["allowedGlobals"] = nil
      opts = _656_0
    end
    local _657_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _657_0) then
      local filename = _657_0
      local _658_
      ...
      return _658_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _663_0 = search_module(module_name, package.path)
    if (nil ~= _663_0) then
      ...
      do
        ...
        code = close_handlers_10_(_G.xpcall(_665_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _667_0 = macro_searchers[n]
    if (nil ~= _667_0) then
      local f = _667_0
      local _668_0, _669_0 = f(modname)
      if ((nil ~= _668_0) and true) then
        local loader = _668_0
        local _3ffilename = _669_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _672_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _672_}, view = view}
    end
  end
  local function _674_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _675_())
  end
  safe_require = _674_
  ...
  local function resolve_module_name(_676_0, _scope, _parent, opts)
    local _677_ = _676_0
    local second = _677_[2]
    local filename = _677_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_683_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _686_0, _687_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_686_0 == true) and (nil ~= _687_0)) then
        local modname = _687_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _691_()
        local _690_0 = search_module(mod)
        if (nil ~= _690_0) then
          local fennel_path = _690_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _691_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _695_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _696_ = _695_[1]
      local expr = _696_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      local subexpr = utils.expr(string.format(string.gsub(("(" .. unpack_fn .. ")(%s, nil, {%s})"), "\n%s*", " "), s, exclude_str), "expression")
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _840_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _841_0 = type(v)
    if (_841_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_841_0 == "table") then
...
do
  ...
  package.preload[module_name] = _845_
  _ = nil
  local env = nil
  do
    local _846_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _846_0["utils"] = utils
    _846_0["fennel"] = mod
    _846_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _846_0
  end
